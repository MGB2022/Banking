...
class SavingsAccount 
{
	...
	//  Constructor Method
	public SavingsAccount(double newInterestRate) 
	{
	...
	public String generateAccountNumber(int ACCT_LIMIT, String SAVINGS_PREFIX)
	{

		int savingsRndNum = ranNumGenerator.nextInt(ACCT_LIMIT);
		
		return (SAVINGS_PREFIX + savingsRndNum);
...
// End of SavingsAccount.java Class